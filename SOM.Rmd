...
```{r}
ads.train <- as.matrix(scale(ads.s[-1]))
som.grid <- somgrid(xdim =3, ydim=3, topo= "hexagonal")
set.seed(100)
ads.som <- som(ads.train, som.grid, rlen = 500)

plot(ads.som, "mapping")
```
```{r}
ads.som$unit.classif
```
```{r, fig.width=20}
plot(ads.som, "codes")
```
...
[^4] [](https://www.superdatascience.com/blogs/self-organizing-maps-soms-how-do-self-organizing-maps-learn-part-1/)
