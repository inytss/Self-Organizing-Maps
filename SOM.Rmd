...
Heatmaps are the most important visualization in SOM. SOM heatmap visualize the distribution of single variable across the map. In general, SOM creating multiple heatmaps to find interesting area by comparing each heatmaps. Remember that each individual sample not move from their position in each heatmaps, but it colored by different variables.
